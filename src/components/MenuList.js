...
const MenuList = ({ menu, index, updateOption, handleDeleteMenu, datos, handleDeleteOpcion }) => {
                                        ...
                                        <div ref={provided.innerRef}{...provided.droppableProps}>
                                            {
                                                menu.options.map((option, index) => (
                                                    <Options option={option} key={option.id} index={index} datos={datos} menu={menu} updateOption={updateOption} handleDeleteOpcion={handleDeleteOpcion} />
                                                ))
